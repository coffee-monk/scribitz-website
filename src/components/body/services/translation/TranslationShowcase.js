        ...
        <div className="relative mx-auto text-white z-40 lg:pb-10 pt-4 lg:pt-10">
          ...
          <div className="max-w-lg pt-12 lg:pb-10">
            <div id="title" className="flex flex-wrap items-start justify-between">
              <h1 className="text-5xl font-bold text-secondary mb-4 z-40">Translation</h1>
            ...
            <div className="text-white">
              <p className="text-3xl font-bold mb-4">Translate Your Files From One Language to Another</p>
              <p className="text-xl z-40 mb-4">
                Consectetur tenetur sequi alias quisquam vero? Ut repudiandae nesciunt qui explicabo tempore? Expedita
                harum nam magnam amet quaerat cumque! Sit?
              </p>
