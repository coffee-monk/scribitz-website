    ...
    >
      <h1 className="flex items-center justify-between font-bold text-lg text-primary">
        ...
        <ChevronUpIcon
          ...
          } transition duration-500 ease-out-in w-5 h-5 ml-2 text-primary border-2 border-primary rounded-full flex-none`}
        />
      </h1>
      <p
        className={`${
          showAnswer ? "max-h-40" : "max-h-0"
        } overflow-hidden transition-[max-height] duration-500 ease-out-in text-gray-800 w-5/6`}
      >
        <br />
